...
<html lang="en">
    ...
    <body>
        ...
        <div class="modal" id="xoamodal" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <!-- Form xử lý chức năng xóa nhân viên -->
        ...
        <div class="search" style="margin-left: 100px; margin-bottom: -10px;">
            ...
            <input type="text" class="form-control" placeholder="Nhập từ khóa..." id="searchnv" style="width: 15%; display: inline-flex; margin-left: 10px; border: 1px solid black;">
        </div>
        
        <div class="data" style="margin-left: 80px;" id="resultnv">
			...
			<table class="table table-hover">
				...
				<?php
                        ...
                        // Dùng hàm cho hiện tất cả nhân viên của Controller
                        $tblstaff = $p->getAllNhanvien();
                        
                        if($tblstaff) {
                            if(mysqli_num_rows($tblstaff) > 0) {    
                        
                                // Xuất dữ liệu nhân viên theo vòng lặp
        ...
        <script>
            ...
            // Tìm kiếm nhân viên theo dạng live search 
            $(document).ready(function() {
                ...
                $('#searchnv').on('input', function() {
                    ...
                    // Ngược lại nếu không nhập hoặc xóa từ khóa sẽ hiện ra tất cả nhân viên
                    } else {
                        $.ajax({
                            url: 'View/vSearchNvien.php',
                            type: 'POST',
